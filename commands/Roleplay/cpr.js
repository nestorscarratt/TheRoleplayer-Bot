...
module.exports = {
    name: "cpr",
    description: "Peforms cardiopulmonary resuscitation",
    execute(message){
      ...
      if(!message.guild.me.hasPermission("MANAGE_MESSAGES"))  {
        ...
        .setTitle('Starting cardiopulmonary resuscitation')
        .setDescription(`<@${message.author.id}> Attempts to start CPR on <@${member.id}>`)
        .setColor('GREEN');
